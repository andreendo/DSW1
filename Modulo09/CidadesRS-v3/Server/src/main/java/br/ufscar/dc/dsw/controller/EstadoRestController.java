...
public class EstadoRestController {
	...
	public EstadoRestController(IEstadoService service) {
	...
	public ResponseEntity<Estado> cria(@Valid @RequestBody Estado estado,
	...
	public ResponseEntity<Estado> atualiza(@PathVariable("id") long id,
